...
import { CREATE_USER_ENDPOINT, DELETE_USER_ENDPOINT, GET_STOCK_ENDPOINT, LOGIN_USER_ENDPOINT } from "../utils/exportedVariables";
...
UserRoute.delete(DELETE_USER_ENDPOINT, (req: Request, res: Response) => {
